<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h2 class="mb-1">Tambah Pengumuman</h2>
        <p class="text-muted mb-0">Buat pengumuman baru untuk sekolah</p>
    </div>
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">
                    <i class="fas fa-plus me-2"></i>Informasi Pengumuman
                </h5>
            </div>
            <div class="card-body">
                <form action="/admin/announcements/store" method="post">
                    <?= csrf_field() ?>
    ...
    <div class="col-lg-4">
        ...
        <div class="card sticky-top" style="top: 20px;">
            <div class="card-header bg-light">
                <h6 class="mb-0">
                    <i class="fas fa-question-circle me-2"></i>Bantuan Tambah
                </h6>
            </div>
            <div class="card-body">
                <h6>Tips Membuat Pengumuman:</h6>
                <ul class="small mb-3">
                ...
                <div class="alert alert-info small">
                    ...
                    <strong>Info:</strong> Pengumuman baru akan langsung tersimpan dan dapat dilihat oleh siswa jika status aktif.
                </div>
            </div>
        </div>
    </div>
