            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <div id="current-images" class="row g-2">
                            <?php if (!empty($gallery['images'])): ?>
                                <?php foreach ($gallery['images'] as $image): ?>
                                    <div class="col-md-4 position-relative">
                                        <img src="/public/uploads/galleries/<?= $image['filename'] ?>" class="img-fluid rounded" style="height: 100px; object-fit: cover;">
                                        <button type="button" class="btn btn-sm btn-danger position-absolute top-0 end-0" onclick="removeImage(<?= $image['id'] ?>, this)">
...
const dropzone = new Dropzone("#dropzone", {
    url: "/admin/galleries/update/<?= $gallery['id'] ?>", // This will be handled by the form
...
function removeImage(imageId, button) {
    if (confirm('Apakah Anda yakin ingin menghapus gambar ini?')) {
        fetch(`/admin/galleries/remove-image/${imageId}`, {
            method: 'POST',
            headers: {
