<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h2 class="mb-1">Tambah Agenda</h2>
        <p class="text-muted mb-0">Buat agenda baru untuk sekolah</p>
    </div>
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">
                    <i class="fas fa-plus me-2"></i>Informasi Agenda
                </h5>
            </div>
            <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="4"
                                      placeholder="Jelaskan tentang agenda ini..."><?= old('description') ?></textarea>
        ...
        <div class="card sticky-top" style="top: 20px;">
            ...
            <div class="card-body">
                ...
                <div class="alert alert-info small">
                    ...
                    <strong>Info:</strong> Agenda baru akan langsung tersimpan dan dapat dilihat oleh siswa.
                </div>
            </div>
        </div>
    </div>
